...
export const Window: React.FC<WindowProps> = ({ log }) => {
  return (
    <>
      ...
      ></div>
      <div className="scrollbar container relative z-10 flex h-[35rem] flex-col gap-10 overflow-y-scroll rounded border border-sky-300 bg-sky-950 bg-opacity-30 p-4 ">
        {log.map((message) => {
          return (
